...
def main():
    ...
    model = CaptionGenerator(word_to_idx, dim_feature=[64, 2048], dim_embed=512,
                                       dim_hidden=1024, n_time_step=16, prev2out=True, 
                                                 ctx2out=True, alpha_c=1.0, selector=True, dropout=True, device_id = '/gpu:1')

    solver = CaptioningSolver(model, data, val_data, n_epochs=20, batch_size=16, update_rule='adam',
