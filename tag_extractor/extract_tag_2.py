...
def _process_caption_data(caption_file, video_dir, video_exist, max_length):
    ...
    for annotation in caption_data['sentences']:
        ...
        if (video_exist_dict is None or video_exist_dict[annotation['video_id']]):
            data += [annotation]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_frames', type=int, default = 10,
                        help='number of frames to sample from each video (default to 10)')
    parser.add_argument('--num_tags', type=int, default = 10,
                        help='number of top n tags to extract (default to 10)')
