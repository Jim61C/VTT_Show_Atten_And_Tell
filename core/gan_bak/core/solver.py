    ...
    def __init__(self, model, data, val_data, **kwargs):
        ...
        Required Arguments:
            ...
            - data: Training data; dictionary with the following keys:
                - features: Feature vectors of shape (82783, 196, 512) (, 1, 2048)
        ...
        with tf.Session(config=config) as sess:
            ...
            for e in range(self.n_epochs):
                ...
                for i in range(n_iters_per_epoch):
                    ...
                    # gan  
                    ground_truths = captions[image_idxs == image_idxs_batch[0]]   #(n,17)
                    gen_caps = sess.run(generated_captions, feed_dict)            #(n,17)
                    # features_batch (n, 1, 2048)
                    gan(ground_truths, gen_caps, features_batch)
