...
def main():
    ...
    solver = CaptioningSolver(model, data, val_data, n_epochs=40, batch_size=256, update_rule='adam',
                    ...
                    pretrained_model=None, model_path='model/show_and_tell/lstm_gan_scratch/', test_model='../show-attend-and-tell-MSRVTT_scratch/model/lstm_MSRVTT_from_scratch/model-6',
                    print_bleu=True, log_path='log_scratch/', reset_embedding=False, use_gan=True)
